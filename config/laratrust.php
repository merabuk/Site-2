...
return [
    ...
    */
    'user_models' => [
        ...
        'userGroups' => \App\Models\UserGroup::class,
    ],
    ...
    */
    'middleware' => [
        ...
        'handlers' => [
            ...
            'abort' => [
                'code' => 403,
                'message' => 'У пользователя не достаточно прав на выполнение данной операции.'
            ],
            ...
            'redirect' => [
                ...
                'message' => [
                    'key' => 'error',
                    'content' => 'У пользователя не достаточно прав на выполнение данной операции.'
                ]
            ]
        ]
    ],
