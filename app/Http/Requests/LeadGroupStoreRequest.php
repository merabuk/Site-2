...
class LeadGroupStoreRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:lead_groups,name',
            'code' => 'required|string|max:255|unique:lead_groups,code',
